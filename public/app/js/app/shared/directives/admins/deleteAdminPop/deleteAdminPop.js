...
define('admins/deleteAdminPop',['admin'], function(admin){
    admin.dp.directive('deleteAdminPop', function(){
        return {
            restrict: 'E', //This means that it will be used as an element and NOT as an attribute.
            replace: true,
            scope: { username: '=' },
            templateUrl: "/app/js/app/shared/directives/admins/deleteAdminPop/deleteAdminPop.html",
